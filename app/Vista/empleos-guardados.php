...
<head>
    ...
    <title>Empleos Guardados - ServiDom</title>
    <link rel="stylesheet" href="../../public/css/catalogo-auth.css">
    <link rel="stylesheet" href="../../public/css/empleos-guardados.css">
</head>
<body>
        ...
        <div class="header-actions">
            ...
            <div class="perfil-container">
                ...
                <div class="dropdown-menu" id="dropdown">
                    ...
                    <a href="empleos-guardados.php" class="dropdown-item active">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="header-info">
                    ...
                    <p>Gestiona tus empleos guardados, postulaciones y procesos activos</p>
                </div>
            </div>
            ...
            <div class="tabs-container">
                <div class="tabs-nav">
                    <button class="tab-btn active" data-tab="guardados">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                        </svg>
                        Guardados
                        <span class="tab-count" id="count-guardados">0</span>
                    </button>
                    <button class="tab-btn" data-tab="postulados">
                        ...
                        Postulados
                        <span class="tab-count" id="count-postulados">0</span>
                    </button>
                    <button class="tab-btn" data-tab="procesados">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"></circle>
                            <polyline points="12 6 12 12 16 14"></polyline>
                        </svg>
                        En Proceso
                        <span class="tab-count" id="count-procesados">0</span>
                    </button>
                </div>
            </div>
            ...
            <div class="tabs-content">
                <!-- Guardados -->
                <div class="tab-panel active" id="panel-guardados">
                    <div class="empleos-grid" id="grid-guardados">
                        <!-- Se cargan dinámicamente -->
                    </div>
                    <div class="empty-state" id="empty-guardados" style="display: none;">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                        </svg>
                        <h3>No tienes empleos guardados</h3>
                        <p>Explora el catálogo y guarda los empleos que te interesen</p>
                        <a href="catalogo-auth.php" class="btn-primary">Ver Catálogo</a>
                    </div>
                </div>

                <!-- Postulados -->
                <div class="tab-panel" id="panel-postulados">
                    <div class="empleos-grid" id="grid-postulados">
                        <!-- Se cargan dinámicamente -->
                    </div>
                    <div class="empty-state" id="empty-postulados" style="display: none;">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                            <polyline points="22 4 12 14.01 9 11.01"></polyline>
                        </svg>
                        <h3>No tienes postulaciones</h3>
                        <p>Postúlate a los empleos que te interesen desde el catálogo</p>
                        <a href="catalogo-auth.php" class="btn-primary">Ver Empleos</a>
                    </div>
                </div>

                <!-- Procesados -->
                <div class="tab-panel" id="panel-procesados">
                    <div class="empleos-grid" id="grid-procesados">
                        <!-- Se cargan dinámicamente -->
                    </div>
                    <div class="empty-state" id="empty-procesados" style="display: none;">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"></circle>
                            <polyline points="12 6 12 12 16 14"></polyline>
                        </svg>
                        <h3>No tienes empleos en proceso</h3>
                        <p>Cuando un cliente acepte tu postulación, aparecerá aquí</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="../Controlador/empleos-guardados.js"></script>
</body>
</html>
