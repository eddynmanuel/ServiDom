...
<head>
    ...
    <title>Historial - ServiDom</title>
...
<body>
        ...
        <div class="header-actions">
            ...
            <div class="perfil-container">
                ...
                <div class="dropdown-menu" id="dropdown">
                    ...
                    <a href="historial.php" class="dropdown-item active">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"></circle>
        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="header-info">
                    ...
                    <p>Revisa tu historial de trabajos y actividades recientes</p>
                </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <span class="stat-number" id="stat-completados">12</span>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <span class="stat-number" id="stat-proceso">3</span>
                        <span class="stat-label">En Proceso</span>
                    </div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon cancelados">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"></circle>
                    ...
                    <div class="stat-info">
                        <span class="stat-number" id="stat-cancelados">1</span>
                        <span class="stat-label">Cancelados</span>
                    </div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon valoracion">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                        </svg>
                    </div>
                    <div class="stat-info">
                        <span class="stat-number" id="stat-valoracion">4.8</span>
    ...
    <script src="../Controlador/historial.js"></script>
</body>
</html>
