...
<head>
    ...
    <title>Valorar Servicio - ServiDom</title>
    <link rel="stylesheet" href="../../public/css/catalogo-auth.css">
    <link rel="stylesheet" href="../../public/css/valoracion.css">
</head>
<body>
    ...
    <main class="main-content">
        <div class="valoracion-card">
            <div class="valoracion-header">
                <div class="avatar-trabajador">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                        <circle cx="12" cy="7" r="4"></circle>
                    </svg>
                </div>
                <h2 id="nombre-trabajador">Nombre del Trabajador</h2>
                <p class="ocupacion" id="ocupacion-trabajador">Ocupación</p>
            </div>
            ...
            <div class="valoracion-estrellas">
                ...
                <p class="texto-valoracion" id="texto-valoracion">Selecciona una valoración</p>
            </div>
            
            <div class="valoracion-comentario">
                <label for="comentario">Comentario (opcional)</label>
                <textarea id="comentario" placeholder="Cuéntanos tu experiencia..."></textarea>
            </div>
            
            <button class="btn-enviar-valoracion" onclick="enviarValoracion()">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <script src="../Controlador/valoracion.js"></script>
</body>
</html>