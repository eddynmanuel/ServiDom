...
<head>
    ...
    <title>Trabajadores - ServiDom</title>
    <link rel="stylesheet" href="../../public/css/catalogo-auth.css">
    <link rel="stylesheet" href="../../public/css/trabajadores.css">
</head>
<body>
    ...
    <main class="main-content">
        <!-- Header de página con botón volver integrado -->
        <div class="page-header">
            <a href="catalogo-auth.php" class="btn-volver-inline">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <line x1="19" y1="12" x2="5" y2="12"></line>
                    <polyline points="12 19 5 12 12 5"></polyline>
                </svg>
            </a>
            <h1 id="categoria-titulo">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="trabajadores-layout">
            ...
            <aside class="subcategorias-sidebar">
                <h3>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <ul id="subcategorias-lista">
                    <!-- Se cargan dinámicamente -->
                </ul>
            </aside>
            
            <!-- Grid de trabajadores -->
            <section class="trabajadores-grid" id="trabajadores-grid">
                <!-- Se cargan dinámicamente -->
            </section>
        </div>
    </main>
    ...
    <script src="../Controlador/trabajadores.js"></script>
</body>
</html>