// Registro de trabajador con datos simulados
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('formRegistroTrabajador');
    if (form) {
        form.addEventListener('submit', validarRegistroTrabajador);
    }
});

function validarRegistroTrabajador(event) {
    ...
    if (ocupacion.length < 2) {
        errores.push('La ocupación debe tener al menos 2 caracteres.');
    }
